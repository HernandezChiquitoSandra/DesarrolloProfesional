...
using static AppBlazor.Shared.DTOs.HomaPageDTO;
...
namespace AppBlazor.Server.Controllers
{
    ...
    public class PeliculasController : ControllerBase
    {
        ...
        public async Task<ActionResult<List<Pelicula>>> Get(
            [FromQuery] ParametrosBusquedaPeliculasDTO modelo)//el filtro se manda a travez del modelo
        {
            var peliculasQueryable = context.Peliculas.AsQueryable();//tipo de dato que se ira armando parte por parte
            ...
            var peliculas = await peliculasQueryable.Paginar(modelo.PaginacionDTO).ToListAsync();//en los if se arma el query y aqui se ejecuta
            return peliculas;
        }
    }
}
